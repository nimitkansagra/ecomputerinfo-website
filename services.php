                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb_box text-center">
                            <h1 class="breadcrumb-title text-color-primary">Services</h1>
        ...
        <div class="tabs-wrapper bg-gray section-space--ptb_60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 ht-tab-wrap">
                        <div class="tab-content ht-tab__content">
                            <h4 class="text-center" id="security_storage">Security & Storage</h4>
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/security.jpg"
                                                    alt="Security">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ht-tab-wrap">
                        <div class="tab-content ht-tab__content">
                            <h4 class="text-center mt-40" id="web_development">Web Development</h4>
                            <!--<div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">-->
                            <div class="tab-history-wrap">
                                <div class="row">
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/website_development.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ht-tab-wrap">
                        <div class="tab-content ht-tab__content">
                            <h4 class="text-center mt-40" id="it_sales_service">IT Sales & Service</h4>
                            <!--<div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">-->
                            <div class="tab-history-wrap">
                                <div class="row">
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/it_sales_service.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ht-tab-wrap">
                        <div class="tab-content ht-tab__content">
                            <h4 class="text-center mt-40" id="networking">Networking</h4>
                            <!--<div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">-->
                            <div class="tab-history-wrap">
                                <div class="row">
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/networking.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/EPABX.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 ht-tab-wrap">
                        <div class="tab-content ht-tab__content">
                            <h4 class="text-center mt-40" id="it_consulting">IT Consulting & Project Management</h4>
                            <!--<div class="tab-pane fade show active" id="tab_list_06" role="tabpanel">-->
                            <div class="tab-history-wrap">
                                <div class="row">
                                    <div class="col-lg-6 ">
                                        <div class="tab-history-image video-popup mt-30">
                                            <div class="single-popup-wrap">
                                                <img class="img-fluid"
                                                    src="assets/images/services/it_consultant.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
