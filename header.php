            ...
            <div class="col-md-12">
                <div class="top-bar-wrap">
                    <div class="top-bar-left">
                        <div class="top-bar-text"><a href="#" class="font-medium display-inline">
                            <a class="info-link">
                                <i class="info-icon fa fa-envelope"></i>
                                <span class="info-text"><strong> &nbsp;support@ecomputerinfo.co.in &nbsp;</strong></span>
                            </a>
                            <a class="info-link">
                                <span class="info-text"> &nbsp;GSTIN : 19DMXPS8854N1ZE</span>
                            </a>
                        </div>
                    </div>
                    <div class="top-bar-right">
                        <ul class="top-bar-info">
                            <li class="info-item">
                                <a href="tel:9163481254" class="info-link">
                                    <i class="info-icon fa fa-phone"></i>
                                    <span class="info-text"><strong>+91 9163481254</strong></span>
                                </a>
                            </li>
                            <li class="info-item">
                                <i class="info-icon fa fa-map-marker-alt"></i>
                                <span class="info-text">524/C Anandamath Ichapur, North 24 pgs, Pin- 743144</span>
                            </li>
                        </ul>
                    </div>
                </div>
