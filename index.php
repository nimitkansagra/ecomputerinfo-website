...
<head>
    ...
    <title>Computer Info - A Complete It Solution</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="feature-images__two small-mt__10">
                            <div class="modern-grid-image-box row row--30">
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60  small-mt__40">
                                    <!-- ht-box-icon Start -->
                                    <a href="services.php#security_storage" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <!--<img class="img-fulid" src="assets/images/icons/mitech-processing-service-image-01-80x83.png" alt="">-->
                                                <img class="img-fulid" src="assets/img/cctv.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="heading">Security & Storage </h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    <!-- ht-box-icon Start -->
                                    <a href="services.php#web_development" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="assets/img/web-development.png" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    <!-- ht-box-icon Start -->
                                    <a href="services.php#it_consulting" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="assets/img/project-management.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="heading">IT Consulting & Project Management</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    <!-- ht-box-icon Start -->
                                    <a href="services.php#it_sales_service" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="assets/img/customer-service.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="heading">IT Sales & Service</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                                ...
                                <div class="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
                                    <!-- ht-box-icon Start -->
                                    <a href="services.php#networking" class="ht-box-images style-02">
                                        <div class="image-box-wrap">
                                            <div class="box-image">
                                                <img class="img-fulid" src="assets/img/networking.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="heading">Networking</h6>
                                            </div>
                                        </div>
                                    </a>
                                    <!-- ht-box-icon End -->
                        ...
                        <div class="section-under-heading text-center section-space--mt_60">Challenges are just opportunities in disguise. <a href="services.php">Read More About Services !</a></div>
                    ...
                    <div class="col-lg-6">
                        <div class="faq-wrapper faq-custom-col">
                            ...
                            <div class="section-title section-space--mb_40">
                                ...
                                <h3 class="heading">Our work with these <span class="text-color-primary"> Industries</span></h3>
                            ...
                            <div id="accordion">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <h5 class="mb-0">
                                            <button class="btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                CORPORATE <span> <i class="fas fa-chevron-down"></i>
                                    ...
                                    <div id="collapseOne" class="show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Corporate Offices and Institutional Establishments like Hotels/ Hospitals/schools and others are our strongest Area and have been providing Turnkey solutions to our clients.. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                RESIDENTIAL<span> <i class="fas fa-chevron-down"></i>
                                            <i class="fas fa-chevron-up"></i> </span>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We work in residential as well as commercial Buildings. We associate with Architects/ Builders / Consultants and work as a Team to arrive at most Optimum Solutions and to meet National and International Standards. </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                INDUSTRIAL <span> <i class="fas fa-chevron-down"></i>
                                            <i class="fas fa-chevron-up"></i> </span>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We specialize in Industrial Projects and add value by designing the systems for them. We are proud to have worked for most prestigious Industries in Food/ Production / Institutions and Power Sector.. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 offset-lg-1">
                        <div class="modern-number-01 mr-5">
                            <h2 class="heading"><span class="mark-text">8</span>Years’ Experience in IT</h2>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">25</div>
                                    <h6 class="fun-fact__text">Team Members</h6>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">59</div>
                                    <h6 class="fun-fact__text">Projects Done</h6>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">199</div>
                                    <h6 class="fun-fact__text">Happy clients</h6>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 wow move-up">
                                <div class="fun-fact--three text-center">
                                    <div class="fun-fact__count counter">2012</div>
                                    <h6 class="fun-fact__text">Established</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                                ...
                                <a href="#" class="box-large-image__two">
                                    <div class="box-large-image__two__box">
                                        ...
                                        <div class="box-info">
                                            ...
                                            <div class="box-more-info">
                                                <div class="text">India has been a front-runner in the use of information technology (IT) and thus making substantial gains on ‘construction permits’ should not come as a surprise. 
                                                    Another area in which IT has proved to be a game changer is ‘starting a business’. The report notes that in the previous year, maximum number of reforms (50) was recorded in this area.</div>
                                                <div class="btn">
                                                    <i class="button-icon far fa-long-arrow-right"></i>
                                                </div>
                                            </div>
                                ...
                                <a href="#" class="box-large-image__two">
                                    <div class="box-large-image__two__box">
                                        ...
                                        <div class="box-info">
                                            ...
                                            <div class="box-more-info">
                                                <div class="text">IT infrastructure is no longer simply an electronic support system. It’s become a pervasive, essential component of daily operations and a foundational factor in determining your firm’s future success.
                                                     The IT infrastructure planning process defines and refines IT’s role within your organization and then identifies what’s needed in the way of equipment, applications and manpower to fulfill that role.</div>
                                                <div class="btn">
                                                    <i class="button-icon far fa-long-arrow-right"></i>
                                                </div>
                                            </div>
                                ...
                                <a href="#" class="box-large-image__two">
                                    <div class="box-large-image__two__box">
                                        ...
                                        <div class="box-info">
                                            ...
                                            <div class="box-more-info">
                                                <div class="text">The Importance of having Firewalls! Firewall is a software or hardware device that protects your computer from being attacked over the internet by hackers, viruses, and worms. ... For example,
                                                     with the firewall the company can control the access to certain websites, giving it the control of how employees use the network, and this helps to manage proper resource of the organisation. </div>
                                                <div class="btn">
                                                    <i class="button-icon far fa-long-arrow-right"></i>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="feature-list-button-box mt-40 text-center">
                                <a href="services.php" class="ht-btn ht-btn-md">Learn more</a>
                                <a href="conact-us.php" class="ht-btn ht-btn-md ht-btn--outline">Contact us</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title-wrap text-center section-space--mb_40">
                            ...
                            <h3 class="heading">What do people praise about <span class="text-color-primary"> Computer Info ?</span></h3>
                        </div>
                                ...
                                <div class="swiper-wrapper testimonial-slider__wrapper">
                                        ...
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                <div class="testimonial-slider__media">
                                                    <img src="assets/images/testimonial/AritraMajumder.jpg" class="img-fluid" alt="">
                                                </div>
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Aritra Majumder</h6>
                                                        <!--<span class="designation">Google Local Guide</span>-->
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">In ichapur providing a complete laptop/desktop solution. Know the owner personally, trust worthy group. Very hard working and commited people.
                                                Multiple payments facility available. Business friendly people. Also provide security solution within enterprise friendly budget.</div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                <div class="testimonial-slider__media">
                                                    <img src="assets/images/testimonial/AnikBose.jpg" class="img-fluid" alt="">
                                                </div>
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Anik Bose</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">Best IT service provider in the city. Good range of products at a reasonable price. Good service and prompt response.</div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                <div class="testimonial-slider__media">
                                                    <img src="assets/images/testimonial/SoumenGhosh.jpg" class="img-fluid" alt="">
                                                </div>
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Soumen Ghosh</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">This place is a good station for all software and hardware problem solution. You can trust them with closed eyes. You will get a clean, quick and reasonable solution there.</div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-slider__one wow move-up">
                                            ...
                                            <div class="testimonial-slider--info">
                                                <div class="testimonial-slider__media">
                                                    <img src="assets/images/testimonial/RohitHalder.jpg" class="img-fluid" alt="">
                                                </div>
                                                ...
                                                <div class="testimonial-slider__author">
                                                    ...
                                                    <div class="author-info">
                                                        <h6 class="name">Rohit Haldar</h6>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="testimonial-slider__text">You will get all variety of computer hardware and also servicing required can be met under one roof within reasonable cost. </div>
                            ...
                            <div class="swiper-container brand-logo-slider__container">
                                <div class="swiper-wrapper brand-logo-slider__one">
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/cp-plus-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/dell-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/dell-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/dlink-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/dlink-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/hp-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/hp-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/microsoft-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/microsoft-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/molex-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/molex-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/quick-heal-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/quick-heal-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/sophos-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/sophos-logo.png" class="img-fluid" alt="">
                                            </div>
                                    ...
                                    <div class="swiper-slide brand-logo brand-logo--slider">
                                        <a href="#">
                                            <div class="brand-logo__image">
                                                <img src="assets/img/brand-logo/tally-logo.png" class="img-fluid" alt="">
                                            </div>
                                            <div class="brand-logo__image-hover">
                                                <img src="assets/img/brand-logo/tally-logo.png" class="img-fluid" alt="">
                                            </div>
                    ...
                    <div class="col-lg-6 col-lg-6">
                        ...
                        <div class="col-lg-6 col-lg-6">
                            <div class="contact-info-two text-center">
                                ...
                                <h2 class="call-us"><a href="tel:9163481254">+91 916 348 1254</a></h2>
    ...
    <script async data-id="27604" src="https://cdn.widgetwhats.com/script.min.js"></script>
